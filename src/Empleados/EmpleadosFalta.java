...
public class EmpleadosFalta extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EmpleadosFalta frame = new EmpleadosFalta();
	...
	public EmpleadosFalta() {
		...
		btnActualizar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ModificarEmpleados.txtNumEmpleado.setText(EmpleadosFalta.NumEmpleado);
				ModificarEmpleados.txtClaveMinera.setText(EmpleadosFalta.ClaveMinera);
				ModificarEmpleados.txtNombre.setText(EmpleadosFalta.Nombre);
				ModificarEmpleados.txtApaterno.setText(EmpleadosFalta.Apaterno);
				ModificarEmpleados.txtAmaterno.setText(EmpleadosFalta.Amaterno);
				ModificarEmpleados.txtPuesto.setText(EmpleadosFalta.Puesto);
				ModificarEmpleados.txtTelefono.setText(EmpleadosFalta.Telefono);
				ModificarEmpleados.txtEdad.setText(EmpleadosFalta.Edad);
				ModificarEmpleados.txtEscolaridad.setText(EmpleadosFalta.Escolaridad);
				ModificarEmpleados.txtNoimss.setText(EmpleadosFalta.Noimss);
				ModificarEmpleados.txtRfc.setText(EmpleadosFalta.Rfc);
				ModificarEmpleados.txtCurp.setText(EmpleadosFalta.Curp);
				ModificarEmpleados.txtCalle.setText(EmpleadosFalta.Calle);
				ModificarEmpleados.txtColonia.setText(EmpleadosFalta.Colonia);
				ModificarEmpleados.txtCiudad.setText(EmpleadosFalta.Ciudad);
				ModificarEmpleados.txtEstado.setText(EmpleadosFalta.Estado);
				ModificarEmpleados.txtEstadoCivil.setText(EmpleadosFalta.EstadoCivil);
				ModificarEmpleados.txtDeconomicos.setText(EmpleadosFalta.DependientesEconomicos);
				ModificarEmpleados.txtNombreEmergencia.setText(EmpleadosFalta.NombreEmergencia);
				ModificarEmpleados.txtTelefonoEmergencia.setText(EmpleadosFalta.TelefonoEmergencia);
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if (arg0.getButton() == 1) {
					...
					try {
						...
						resultSet.next();
						EmpleadosFalta.NumEmpleado = resultSet.getString("num_empleado");
						EmpleadosFalta.ClaveMinera = resultSet.getString("clave_minera");
						EmpleadosFalta.Nombre = resultSet.getString("nombre");
						EmpleadosFalta.Apaterno = resultSet.getString("apellido_paterno");
						EmpleadosFalta.Amaterno = resultSet.getString("apellido_materno");
						EmpleadosFalta.Puesto = resultSet.getString("puesto");
						EmpleadosFalta.Telefono = resultSet.getString("telefono");
						EmpleadosFalta.Edad = resultSet.getString("edad");
						EmpleadosFalta.Escolaridad = resultSet.getString("escolaridad");
						EmpleadosFalta.Noimss = resultSet.getString("no_imss");
						EmpleadosFalta.Rfc = resultSet.getString("rfc");
						EmpleadosFalta.Curp = resultSet.getString("curp");
						EmpleadosFalta.Calle = resultSet.getString("calle");
						EmpleadosFalta.Colonia = resultSet.getString("colonia");
						EmpleadosFalta.Ciudad = resultSet.getString("ciudad");
						EmpleadosFalta.Estado = resultSet.getString("estado");
						EmpleadosFalta.EstadoCivil = resultSet.getString("estado_civil");
						EmpleadosFalta.DependientesEconomicos = resultSet.getString("dependientes_economicos");
						EmpleadosFalta.NombreEmergencia = resultSet.getString("nombre_emergencia");
						EmpleadosFalta.TelefonoEmergencia = resultSet.getString("telefono_parentesco");
					...
					try{
						...
						con = conex.conexion(hola);
						String existente="SELECT max(fecha) FROM faltas_has_empleados WHERE num_empleado='"+IdEmpleado+"' and tipo_falta='1'";
						String existente2="SELECT max(fecha) FROM faltas_has_empleados WHERE num_empleado='"+IdEmpleado+"' and tipo_falta='2'";
						String existente3="SELECT max(fecha) FROM faltas_has_empleados WHERE num_empleado='"+IdEmpleado+"' and tipo_falta='3'";
						ResultSet rs= ((java.sql.Statement) comando).executeQuery(existente);
						
						System.out.println(existente);
						
						SimpleDateFormat formatoDelTexto = new SimpleDateFormat("yyyy-MM-dd");
						String feca=AltaFaltas.fechaF;
						String strFecha = feca;
						Date fecha = null;
						try {
						...
						SimpleDateFormat dateFormatano = new SimpleDateFormat(formatoano);
						if(rs.next()){
							
							String fechaComp=rs.getObject(1).toString();
							String strFechaCopm = fechaComp;
							Date fechacomp = formatoDelTexto.parse(strFechaCopm);
							
							int mesDtb= Integer.parseInt(dateFormatMes.format(fechacomp));
							int diaDtb=Integer.parseInt(dateFormatDia.format(fechacomp));
							int anoDtb=Integer.parseInt(dateFormatano.format(fechacomp));
							
							int mesAct= Integer.parseInt(dateFormatMes.format(fecha));
							int diaAct= Integer.parseInt(dateFormatDia.format(fecha));
							
							if(mesAct>mesDtb && diaAct>=diaDtb){
								...
								if(mesAct==mesDtb+2){
									...
									AltaFaltas.falta1.setText(diaDtb+"/"+mesDtb+"/"+anoDtb);
									AltaFaltas.falta1.setBackground(new Color(208, 255,136));
									AltaFaltas.falta1.setEnabled(false);
									AltaFaltas.falta1.setForeground(new Color(0,0,0));
									AltaFaltas.falta2.setEnabled(true);
									ResultSet rs2= ((java.sql.Statement) comando).executeQuery(existente2);
									if(rs2.next()){
										String fechaComp2=rs2.getObject(1).toString();
										String strFechaCopm2 = fechaComp2;
										Date fechacomp2 = formatoDelTexto.parse(strFechaCopm2);
										int mesDtb2= Integer.parseInt(dateFormatMes.format(fechacomp2));
										int diaDtb2=Integer.parseInt(dateFormatDia.format(fechacomp2));
										int anoDtb2=Integer.parseInt(dateFormatano.format(fechacomp2));
										AltaFaltas.falta2.setText(diaDtb2+"/"+mesDtb2+"/"+anoDtb2);
										AltaFaltas.falta2.setBackground(new Color(255, 214,117));
										AltaFaltas.falta2.setEnabled(false);
										AltaFaltas.falta2.setForeground(new Color(0,0,0));
										AltaFaltas.falta3.setEnabled(true);
									}
									ResultSet rs3= ((java.sql.Statement) comando).executeQuery(existente3);
									if(rs3.next()){
									
										String fechaComp3=rs3.getObject(1).toString();
										String strFechaCopm3 = fechaComp3;
										Date fechacomp3 = formatoDelTexto.parse(strFechaCopm3);
										int mesDtb3= Integer.parseInt(dateFormatMes.format(fechacomp3));
										int diaDtb3=Integer.parseInt(dateFormatDia.format(fechacomp3));
										int anoDtb3=Integer.parseInt(dateFormatano.format(fechacomp3));
										AltaFaltas.falta3.setText(diaDtb3+"/"+mesDtb3+"/"+anoDtb3);
										AltaFaltas.falta3.setBackground(new Color(255,148,148));
										AltaFaltas.falta3.setEnabled(false);
										AltaFaltas.falta3.setForeground(new Color(0,0,0));
										JOptionPane.showMessageDialog(null, "Este usuario llegó al limite de faltas en el mes");
															}
								}
